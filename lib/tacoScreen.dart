...
class TacoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String extraDescription1 = "* Served with red rice, black beans, corn & romaine salad, tortilla chips";

    return Scaffold(
      appBar: AppBar(
        title: const Text("Tacos",style: TextStyle(fontSize:32, fontStyle:FontStyle.italic,fontWeight: FontWeight.bold)),
        toolbarHeight: 100,
        centerTitle: true,
      ),
