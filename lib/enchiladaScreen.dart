...
class EnchiladaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String extraDescription1 = "* With Southern Succotash, Black Beans with Chipotle Crema";
    String extraDescription2 = "* Choice of Beef, Chicken, Cheese or Veggie";
    String extraDescription3 = "* uno 8.50    * dos 9.95    * tres 11.50";
    return Scaffold(
      appBar: AppBar(
        title: const Text("Enchiladas",style: TextStyle(fontSize:32, fontStyle:FontStyle.italic,fontWeight: FontWeight.bold)),
        toolbarHeight: 100,
        centerTitle: true,
      ),
