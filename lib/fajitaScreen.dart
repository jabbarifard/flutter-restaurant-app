...
class FajitaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String extraDescription1 = "* Served with red rice, black beans, grilled tomato salad, choice of cornor flour tortillas";

    return Scaffold(
      appBar: AppBar(
        title: const Text("Fajitas",style: TextStyle(fontSize:32, fontStyle:FontStyle.italic,fontWeight: FontWeight.bold)),
        toolbarHeight: 100,
        centerTitle: true,
      ),
